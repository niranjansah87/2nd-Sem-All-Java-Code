...
public class Showroom {
	...
	private static ArrayList<Car> eng;
	private static void initialize() {
		s=new Scanner(System.in);
		eng=new ArrayList<Car>();
	...
	private static int menuoption()
	{
		...
		System.out.println("4.Update Car detail");
	...
	private static Car getCarDetail() {
		...
		return  new Car(s.nextLine(),s.nextLine(),s.nextLine(),s.next(),s.nextInt(), null);
	}
